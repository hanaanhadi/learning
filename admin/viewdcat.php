            ...
            <?php require_once('db/conn.php');?> 
             <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <br><br><p class="btn btn-lg" style="background-color: rgb(66, 194, 251); color: white;">All Inserted Subjects Are :</p><br><br>
                                ...
                                <tr>
                                  ...
                                  <?php echo $row['detail_desc'];?></td>
                                     <td class="text-right" style="width: 70px;">
                                            <a href="upd_detcat.php?uid= <?php echo $row['detail_id']; ?>&sid=<?php echo $row['sub_id'] ; ?>"class="btn btn-default btn-xs" id= "updbtn"data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil"></i></a>
